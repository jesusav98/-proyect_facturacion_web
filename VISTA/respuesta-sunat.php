...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="css/respuesta-sunat.css">
            ...
            <div class="row">
              ...
              <div class="col-sm-12">
                <div class="table-responsive">        
                  <table id="respuesta-sunat" class="table table-responsive table-striped table-bordered " style="width:100%">
                      <thead>
                          <tr>
                              <th class="Num">Núm.</th>
              ...
              <div class="container botones">
                  <button type="submit" class="generar">Generar Correo</button>
                  <button type="submit" class="generar">Anulación</button>
              </div>
            </div>  
          </div>    
        </div>
...
<!--    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>-->
    ...
    <script type="text/javascript" src="js/respuesta-sunat.js"></script> 
  </body>
</html>